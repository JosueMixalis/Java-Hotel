...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
					...
					Long diferenciaMilisegundos =  (txtFechaSalida.getDate().getTime() - txtFechaEntrada.getDate().getTime());
				    Long diferenciaDias = diferenciaMilisegundos / (24 * 60 * 60 * 1000);
				    
				    if(diferenciaDias>0) {
				    	price = diferenciaDias*500l;
		...
		txtValor.setBounds(78, 328, /*43*/60, 33);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null ) {	
					ReservasDao reserva = new ReservasDao(new ConnectionFactory().recuperaConexion());
					Long bookingId = reserva.registrarBooking(ReservasView.txtFechaEntrada.getDate(),ReservasView.txtFechaSalida.getDate(), (String)txtFormaPago.getSelectedItem(),price);
					JOptionPane.showMessageDialog(null, "Tu reserva ha sido registrada.");
					RegistroHuesped registro = new RegistroHuesped(bookingId);
