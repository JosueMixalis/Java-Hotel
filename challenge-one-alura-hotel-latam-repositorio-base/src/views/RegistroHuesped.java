...
public class RegistroHuesped extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHuesped frame = new RegistroHuesped(bookingId);
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(Long bookingId) {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (!txtApellido.getText().isEmpty() && !txtNombre.getText().isEmpty() && txtFechaN.getDate() != null && txtTelefono.getText() != null) {
				        RegistroHuespedDao rhd = new RegistroHuespedDao(new ConnectionFactory().recuperaConexion());
				        rhd.registraUsuario(txtApellido.getText(),txtNombre.getText(),txtFechaN.getDate(), txtTelefono.getText(),
				        		txtNacionalidad.getSelectedItem().toString(),bookingId);
				} else {
